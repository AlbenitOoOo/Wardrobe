...
namespace Wardrobe.Controllers
{
    ...
    public class ColorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Color color)
        {
            if (id != color.Id)
            {
                return NotFound();
